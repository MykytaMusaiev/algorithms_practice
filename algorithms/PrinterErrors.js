...
// for the sake of simplicity, are named with letters from a to m. The colors used by the printer
// are recorded in a control string. For example a "good" control string would be aaabbbbhaijjjm
// meaning that the printer used three times color a, four times color b, one time color h then
// one time color a...  Sometimes there are problems: lack of colors,
// technical malfunction and a "bad" control string is produced e.g.
// aaaxbbbbyyhwawiwjjjwwm with letters not from a to m. You have to write a
